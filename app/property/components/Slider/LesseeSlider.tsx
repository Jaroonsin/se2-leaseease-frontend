			...
			<div className="flex h-[2.5rem] p-[0.625rem] [0.75rem] items-center gap-[1.5rem] self-stretch">
				...
				<div className="flex center gap-2 absolute right-2">
					...
					<svg
						...
						viewBox="0 0 16 16"
						fill="none"
						className={`w-[16px] h-[16px] border border-s-slate-300 g-8 rounded-sm ${currentRequest === 0 ? 'bg-slate-100' : 'bg-white'
							}`}
					...
					<svg
						...
						viewBox="0 0 16 16"
						fill="none"
						className={`w-[16px] h-[16px] border border-s-slate-300 g-8 rounded-sm ${currentRequest + 1 === totalRequests ? 'bg-slate-100' : 'bg-white'
							}`}
