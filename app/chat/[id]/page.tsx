								...
								<button onClick={handleSendMessage} className='ml-[0.5rem]'>
									<svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 16 16" fill="none">
										<g clipPath="url(#clip0_4863_6095)">
											<path d="M14.6673 1.33301L10.0007 14.6663L7.33398 8.66634M14.6673 1.33301L1.33398 5.99967L7.33398 8.66634M14.6673 1.33301L7.33398 8.66634" stroke="#9CA3AF" strokeLinecap="round" strokeLinejoin="round" />
										</g>
										<defs>
...
||||||| parent of 771aa60 (finish from lessor to lessee)
=======
'use client'
import { useState, useEffect } from 'react'
import { useDispatch, useSelector } from 'react-redux'
...
>>>>>>> 771aa60 (finish from lessor to lessee)
